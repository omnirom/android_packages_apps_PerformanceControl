...
public class BatteryInfo extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup root, Bundle savedInstanceState) {
        ...
        if (new File(BLX_PATH).exists()) {
            ...
            mBlxVal.setText(
                    getString(R.string.blx_title) + " " + Helpers.readOneLine(BLX_PATH) + "%");
    ...
    public void onResume() {
        ...
        context.registerReceiver(
                this.batteryInfoReceiver, new IntentFilter(Intent.ACTION_BATTERY_CHANGED));
    }
    ...
    private BroadcastReceiver batteryInfoReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            mbattery_status.setText((temperature / 10) + "°C  " +
                    getResources().getStringArray(R.array.batt_status)[status]);
